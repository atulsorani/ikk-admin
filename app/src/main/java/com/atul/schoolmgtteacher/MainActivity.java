    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numb.equals("12345")){
            ...
            pclass.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MainActivity.this, plusclass.class);
            ...
            addstud.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    *//**//*
                    PopupMenu popupMenu = new PopupMenu(MainActivity.this,addstud);
                    ...
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (id == R.id.studadd){
                                ...
                                Intent intent = new Intent(MainActivity.this, add_teacher.class);
                                startActivity(intent);
                            }
                            return true;
                        }
        ...
        notii.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, noticee.class);
                startActivity(intent);
            }
        });
